...
const navItems = ["New In", "Women", "Men", "Sale"];
...
export function Header() {
  ...
  return (
    <header className="relative z-30 bg-white">
      <div className="h-[18px] bg-[#030711] px-2 text-center text-[7px] leading-[18px] text-white md:h-9 md:px-4 md:text-[12px] md:leading-9">
      ...
      <div className="border-b border-[#E5E7EB]">
        <div className="mx-auto flex h-[65px] w-full items-center justify-between px-6 md:hidden">
          ...
          <a href="#top" className="flex shrink-0 items-center gap-[9px]" aria-label="STYLE home">
            <span
              aria-hidden="true"
        ...
        <div className="mx-auto hidden h-[78px] max-w-[1376px] items-center gap-6 px-8 md:flex">
          <a href="#top" className="flex shrink-0 items-center gap-2" aria-label="STYLE home">
            <span
              aria-hidden="true"
              className="grid h-8 w-8 shrink-0 place-items-center rounded-[12px] bg-[#030711] text-[20px] font-bold leading-7 text-white"
            >
          ...
          <nav className="flex items-center gap-9 text-[13px] font-medium" aria-label="Primary navigation">
            {navItems.map((item) => (
              <a key={item} href="#featured" className="transition-opacity hover:opacity-60">
                {item}
              </a>
            ))}
          </nav>
